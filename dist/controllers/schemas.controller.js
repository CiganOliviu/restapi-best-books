...
exports.operateOverSchemasController = void 0;
...
function operateOverSchemasController(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((0, general_controllers_1.isUpdateRequest)(request)) {
            ...
            return (0, general_controllers_1.operateWithUpdateRequest)(response, requestData, updateData, schemas_models_1.default);
        }
        return response.sendStatus(404);
    });
}
exports.operateOverSchemasController = operateOverSchemasController;
